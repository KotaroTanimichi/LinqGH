...
{
    public abstract class LinqExpressionBase : GH_Param<IGH_Goo>, IGH_PreviewObject
    {
        protected LinqExpressionBase(IGH_InstanceDescription tag) : base(tag)
        {
        }

        protected LinqExpressionBase(IGH_InstanceDescription tag, GH_ParamAccess access) : base(tag, access)
        {
        }
        ...
        protected override void OnVolatileDataCollected()
        {
            ...
            foreach (var path in VolatileData.Paths)
            {
                ...
                IEnumerable<object> values = GooHelper.ExtractValues(inputs);
