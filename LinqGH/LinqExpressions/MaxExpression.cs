...
{
    public class MaxExpression : LinqExpressionBase
    {

        public MaxExpression(IGH_InstanceDescription tag) : base(tag)
        {
        }

        public MaxExpression(IGH_InstanceDescription tag, GH_ParamAccess access) : base(tag, access)
        {
        }

        public MaxExpression() : base("MaxExpression", "MaxExpression", "Returns the maximum value in a sequence of values. ex. \"x => x*x\"")
        {
        }
